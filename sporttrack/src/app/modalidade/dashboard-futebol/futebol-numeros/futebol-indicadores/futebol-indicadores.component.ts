...
@Component({
  selector: 'app-futebol-indicadores',
  templateUrl: './futebol-indicadores.component.html',
  styleUrls: ['./futebol-indicadores.component.css']
})


export class FutebolIndicadoresComponent implements OnInit {

  private chart: AmChart;
  private entidade: Entidade;
  private variaveis: Map<any, any> = new Map<any, any>();
  ...
  ngAfterViewInit() {
    ...
    this.sharedEntity.entidadeInformada$.subscribe(ent => {
      ...
      this.pontoService.getPontosParaEntidade(this.entidade.id).subscribe(response => {
        ...
        this.chart = this.AmCharts.makeChart("serialdiv", {
          "type": "serial",
          "theme": "light",
          "hideCredits":true,
          "marginRight": 0,
